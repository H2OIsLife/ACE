...
### Another method of getting a marginal test provides similar results.
	#three way interaction: N by P by trace
rda.maum.rare.hel.int=rda(maum.rare.hel[,7:73] ~ maum.rare.hel$trace:maum.rare.hel$nitrogen:maum.rare.hel$phosphorus + Condition(maum.rare.hel$trace + maum.rare.hel$nitrogen +maum.rare.hel$phosphorus))
	anova(rda.maum.rare.hel.int)
	summary(rda.maum.rare.hel.int)		
	#N by P
	rda.maum.rare.hel.intNP=rda(maum.rare.hel[,7:73] ~ maum.rare.hel$nitrogen:maum.rare.hel$phosphorus + Condition(maum.rare.hel$trace + maum.rare.hel$nitrogen +maum.rare.hel$phosphorus))
	anova(rda.maum.rare.hel.intNP)
	summary(rda.maum.rare.hel.intNP)	
	
	#N by trace
		rda.maum.rare.hel.intNT=rda(maum.rare.hel[,7:73] ~ maum.rare.hel$nitrogen:maum.rare.hel$trace + Condition(maum.rare.hel$trace + maum.rare.hel$nitrogen +maum.rare.hel$phosphorus))
	anova(rda.maum.rare.hel.intNT)
	summary(rda.maum.rare.hel.intNT)
	#P by trace
			rda.maum.rare.hel.intPT=rda(maum.rare.hel[,7:73] ~ maum.rare.hel$phosphorus:maum.rare.hel$trace + Condition(maum.rare.hel$trace + maum.rare.hel$nitrogen +maum.rare.hel$phosphorus))
	anova(rda.maum.rare.hel.intPT)
	summary(rda.maum.rare.hel.intPT)
...
sp.aff.rowsm=match(na.omit(sp.affm)[1:l],rownames(rda.maum.rare.hel.all.spscores))
...
### Another method of getting a marginal test provides similar results.
rda.ne.rare.hel.int=rda(ne.rare.hel[,8:150] ~ ne.rare.hel$trace:ne.rare.hel$nitrogen:ne.rare.hel$phosphorus + Condition(ne.rare.hel$trace + ne.rare.hel$nitrogen +ne.rare.hel$phosphorus))
...
sp.affne=rownames(sp.rsqne)[sp.rsqne[,2]>0.4]
lne=length(na.omit(sp.affne))
sp.aff.rowsne=match(na.omit(sp.affne)[1:l],rownames(rda.ne.rare.hel.all.spscores))
text(rda.ne.rare.hel.all.spscores[sp.aff.rowsne,1:2],labels=rownames(rda.ne.rare.hel.all.spscores[sp.aff.rowsne,]))
```
GREEN BAY RDA
```{r}
#add columns for treatments n,p,trace as y/n for analysis of interactive effects
...
sp.affgb=rownames(sp.rsqgb)[sp.rsqgb[,2]>0.3]
lgb=length(na.omit(sp.affgb))
sp.aff.rowsgb=match(na.omit(sp.affgb)[1:lgb],rownames(rda.gb.rare.hel.all.spscores))
text(rda.gb.rare.hel.all.spscores[sp.aff.rowsgb,1:2],labels=rownames(rda.gb.rare.hel.all.spscores[sp.aff.rowsgb,]))
...
sp.aff=rownames(sp.rsq)[sp.rsq[,2]>0.4]
l=length(na.omit(sp.aff))
sp.aff.rows=match(na.omit(sp.aff)[1:l],rownames(rda.ford.rare.hel.all.spscores))
text(rda.ford.rare.hel.all.spscores[sp.aff.rows,1:2],labels=rownames(rda.ford.rare.hel.all.spscores[sp.aff.rows,]))
```
